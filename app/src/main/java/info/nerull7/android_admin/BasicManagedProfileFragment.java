...
public class BasicManagedProfileFragment extends Fragment
    ...
    private static final String[] PACKAGE_NAMES_SETTINGS = { // TEST NOT SETTINGS FIXME
            "com.android.settings"
    };

    private static final String[] PACKAGE_NAMES_EMAIL = {
    ...
    public void onAttach(Activity activity) {
        ...
        mEmailEnabled = false;
        for (String packageName : PACKAGE_NAMES_EMAIL) {
            if (!manager.isApplicationBlocked(
                    BasicDeviceAdminReceiver.getComponentName(activity), packageName)) {
                mEmailEnabled = true;
                return;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Switch toggleSettings = (Switch) view.findViewById(R.id.toggle_settings);
        toggleSettings.setChecked(mSettingsEnabled);
        toggleSettings.setOnCheckedChangeListener(this);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
        switch (compoundButton.getId()) {
            ...
            case R.id.toggle_settings: {
                setAppEnabled(PACKAGE_NAMES_SETTINGS, checked);
                mSettingsEnabled = checked;
                break;
            }
            case R.id.toggle_email: {
                setAppEnabled(PACKAGE_NAMES_EMAIL, checked);
    ...
    private void setChromeRestrictions() {
        ...
        settings.putString("IncognitoModeAvailability", "0");
